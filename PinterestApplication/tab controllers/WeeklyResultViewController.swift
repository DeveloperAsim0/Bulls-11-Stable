//
//  WeeklyResultViewController.swift
...
class WeeklyResultViewController: UIViewController {
    ...
    @IBOutlet weak var tableView: UITableView!
       ...
       func Get_Details() {
           ...
           print("myparams:- \(parameters)")
                  AF.request("https://projectstatus.co.in/Bulls11/api/authentication/my-weekly-team", method: .post, parameters: parameters,encoding: JSONEncoding.default, headers: header).authenticate(username: "admin", password: "1234").responseJSON { response in
   ...
   extension WeeklyResultViewController: UITableViewDataSource, UITableViewDelegate {
